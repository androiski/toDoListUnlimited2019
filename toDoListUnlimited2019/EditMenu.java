...
public class EditMenu extends JFrame {
	...
	public EditMenu() {
		...
		JCheckBox chckbxNewCheckBox = new JCheckBox("Task Complete");
		chckbxNewCheckBox.setBounds(142, 292, 97, 23);
		contentPane.add(chckbxNewCheckBox);
		
		JComboBox comboBox_6 = new JComboBox();
		comboBox_6.setModel(new DefaultComboBoxModel(new String[] {"1", "2", "3", "4", "5", "6", "7", "8", "9"}));
		comboBox_6.setBounds(377, 293, 41, 20);
		contentPane.add(comboBox_6);
		
		JLabel lblPriority = new JLabel("Priority:");
		lblPriority.setBounds(332, 296, 46, 14);
